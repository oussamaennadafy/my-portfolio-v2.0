    ...
    <div className="relative grid max-w-lg gap-8 mx-auto mt-14 sm:mt-16 md:mx-0 md:max-w-none md:grid-cols-2 lg:grid-cols-3 lg:gap-x-5 lg:gap-y-6 xl:gap-x-6 xl:gap-y-8">
      {featured && (
        <div className="absolute hidden gap-6 -top-20 lg:-left-4 xl:flex 2xl:-left-24">
          <span className="inline-block text-2xl tracking-wide transform -rotate-12 font-writing text-slate-600 dark:text-slate-200">
            Read the latest
          </span>
          ...
          <svg
            ...
            className="relative w-16 h-auto transform rotate-45 -left-1 top-2 -scale-100 text-slate-600 dark:text-slate-200"
          >
            <path
