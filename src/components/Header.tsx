...
export function Header() {
                      ...
                      <>
                        ...
                        >
                          ...
                          >
                            <path
                              fillRule="evenodd"
                              d="M7.21 14.77a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z"
                              clipRule="evenodd"
                            />
                          </svg>
                        </Disclosure.Button>
  ...
  return (
    <header className="h-24 border-b border-slate-200/80 dark:border-gray-800 bg-white dark:bg-gray-950 transition-all fixed top-0 z-50 w-full">
