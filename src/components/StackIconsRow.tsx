...
function StackIcon({ icon, alt, index }) {
  ...
  return (
    <div
      className={clsx(
        'flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-slate-50/90 shadow-sm shadow-sky-100 ring-1 ring-slate-100 dark:shadow-md dark:bg-white/5 dark:shadow-gray-800/20 dark:ring-gray-800 sm:h-[88px] sm:w-[88px]',
        mtClass
      )}
    >
    ...
    <section className="relative flex justify-center pt-16 bg-white dark:bg-gray-950 gap-x-12 overflow-x-clip sm:gap-x-16 lg:pt-12 lg:pb-14">
      ...
      <div className="absolute -top-2.5 right-4 flex transform gap-6 sm:right-16 lg:top-[unset] lg:right-0 lg:-bottom-12 xl:-bottom-20 2xl:right-32">
        <svg
          ...
          className="relative -top-4 -right-1 h-auto w-[68px] rotate-[160deg] transform text-slate-600 dark:text-slate-500 lg:w-20 lg:rotate-[30deg] lg:-scale-x-100"
        >
          <path
        ...
        <span className="inline-block w-48 rotate-6 transform font-writing text-[22px] tracking-wide text-slate-600 dark:text-slate-500 lg:text-2xl">
